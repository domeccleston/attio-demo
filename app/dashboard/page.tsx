...
const sampleModels: Model[] = [
  { id: '1', name: 'Sentiment Analysis', type: 'NLP', status: 'active', lastUpdated: '2023-04-15', version: '1.2.0', analytics: { requests: 15234, accuracy: 0.92 }, trend: [65, 59, 80, 81, 56, 55, 40] },
  { id: '2', name: 'Image Classification', type: 'Computer Vision', status: 'active', lastUpdated: '2023-04-10', version: '2.1.0', analytics: { requests: 8765, accuracy: 0.89 }, trend: [30, 40, 35, 50, 49, 60, 70] },
  { id: '3', name: 'Fraud Detection', type: 'Machine Learning', status: 'inactive', lastUpdated: '2023-03-28', version: '1.0.1', analytics: { requests: 3210, accuracy: 0.95 }, trend: [80, 75, 65, 60, 55, 45, 40] },
  { id: '4', name: 'Recommendation Engine', type: 'Machine Learning', status: 'active', lastUpdated: '2023-04-12', version: '3.0.2', analytics: { requests: 21098, accuracy: 0.88 }, trend: [40, 45, 50, 55, 60, 75, 80] },
];
    ...
    <div className="min-h-screen bg-gray-50">
      <header className="p-4 flex justify-between items-center">
        <div className="flex items-center space-x-4">
          <h3 className="font-bold text-xl tracking-tight"><Link href="/">ModelFlow</Link></h3>
        ...
        <div className="hidden md:flex items-center space-x-4">
          <Link href="/pricing" className="px-4 py-2 text-sm font-medium text-gray-700 bg-white border border-gray-300 rounded-md hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 transition duration-150 ease-in-out">
            Contact Sales
          </Link>
        ...
        <div className="md:hidden">
          ...
          <div className="pt-4 pb-3 border-t border-gray-200">
            ...
            <div className="mt-3 px-2 space-y-1">
              <button
                className="block w-full px-3 py-2 rounded-md text-base font-medium text-gray-700 hover:bg-gray-50 hover:text-gray-900"
              >
                Contact Sales
              </button>
            </div>
      ...
      <div className="max-w-7xl mx-auto px-4 py-8">
        <h2 className="text-2xl font-semibold mb-6 text-gray-900">Deployed Models</h2>
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {sampleModels.map((model) => (
            <div key={model.id} className="bg-white border border-gray-200 rounded-lg overflow-hidden hover:shadow-md transition-shadow duration-300 cursor-pointer">
              <div className="p-4">
                ...
                <div className="space-y-1 mb-2 text-sm">
                  ...
                  <p className="text-gray-500">
                    <span className="font-medium text-gray-700">Updated:</span> {model.lastUpdated}
                  </p>
                </div>
                <div className="flex justify-between items-end mt-3">
                  <div className="flex items-center space-x-3 text-sm">
                    <div className="flex items-center space-x-1">
                      ...
                      <span className="text-gray-600">{model.analytics.requests.toLocaleString()}</span>
                    </div>
                    <div className="flex items-center space-x-1">
                      <span className="font-medium text-gray-700">{(model.analytics.accuracy * 100).toFixed(1)}%</span>
                    </div>
                  </div>
                  <CircularGauge value={Math.round(model.analytics.accuracy * 100)} />
                </div>
              </div>
